...
class Channel(Playlist):
    ...
    def social_links(self) -> list:
        ...
        social_links_list = []
        try:
            social_links = self.about_page_initial_data["contents"]["twoColumnBrowseResultsRenderer"]["tabs"][-2]["tabRenderer"]["content"]["sectionListRenderer"]["contents"][0]["itemSectionRenderer"]["contents"][0]["channelAboutFullMetadataRenderer"]
            
            try:
                social_links = social_links['primaryLinks']
            except KeyError as e:
                social_links_list = None
                return social_links_list   
            
            for social_link in social_links:
                k = unquote(social_link["title"]["simpleText"])
